...
#+begin_src lua
  ...
  function default_window_layout()
      return {
          ...
          {"Terminal", nil, lt_screen, hs.layout.maximized, nil, nil},
      }
  end
...
#+begin_src lua
  ...
  hs.hotkey.bind(modifier, "A", switch_to_focus_layout)
...
#+begin_src lua
  ...
  function switch_to_mob_layout()
      ...
      hs.layout.apply(window_layout)
      hs.application.find("DBeaver"):setFrontmost()
      hs.alert.show("Mob Layout")

  end

  hs.hotkey.bind(modifier, "S", switch_to_mob_layout)
