...
- Advantage: integrated with emacs, so benefits from emacs functionality
- Disadvantage: Because it's not a full terminal emulator, there's some things it doesn't do as well. We can use term-mode or vterm for those.
