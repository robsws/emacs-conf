...
#+begin_src lua
  ...
  function move_focused_window(direction)
      ...
      if #screens == 1 then
          resize_cases = {
              ["left"] = function() get_fractional_screen_rect(new_screen, 0.0, 0.5) end,
              ["right"] = function() get_fractional_screen_rect(new_screen, 0.5, 0.5) end,
              ["whole"] = function() get_fractional_screen_rect(new_screen, 0.0, 1.0) end
          }
  ...
  hs.hotkey.bind(modifier, "B", function() move_focused_window("left") end)
  hs.hotkey.bind(modifier, "F", function() move_focused_window("right") end)
  hs.hotkey.bind(modifier, "W", function() move_focused_window("whole") end)
